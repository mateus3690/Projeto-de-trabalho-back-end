...
class DirectCalendario(Resource):
     ...
     def get(self, chave):
          ...
          try:
               pontoDeTrabalho = Calendario.query.order_by(Calendario.primeiro_ponto.desc()).filter_by(chave=chave).limit(31)
     ...
     def delete(self, chave):
          ...
          try:
               pontoDeTrabalho = Calendario.query.filter_by(chave=chave).first()
